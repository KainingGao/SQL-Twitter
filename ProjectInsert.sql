...
-- Loading user data
LOAD DATA LOCAL INFILE 'C:\\Users\\kygao\\Downloads\\363 Project 3\\dataCSV\\user.csv'
...
-- loading tweets data
LOAD DATA LOCAL INFILE 'C:\\Users\\kygao\\Downloads\\363 Project 3\\dataCSV\\tweets.csv'
INTO TABLE tweets
FIELDS TERMINATED BY ';' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'C:\\Users\\kygao\\Downloads\\363 Project 3\\dataCSV\\tagged.csv'
INTO TABLE hashtags
FIELDS TERMINATED BY ';' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
